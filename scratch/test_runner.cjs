...
assert(canAccess("logistik", "LOGISTIK") === true, "Petugas Logistik bisa akses Divisi Logistik");
assert(canAccess("logistik", "DEPOT") === false, "Petugas Logistik DITOLAK akses Divisi Depot");
