...
with open('scratch/logistik_4sec_fixed_db.json', encoding='utf-8') as f:
      ...
      <div class="alert alert-primary d-flex align-items-center justify-content-between p-3 mb-4 shadow-sm border-0">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <span class="small text-muted">Seluruh 4 Seksi (I, II, III, IV) terisi data presisi dari Master Excel!</span>
          </div>
        </div>
...
print('DIRECTLY WROTE FIXED SEC4 FULL DATA SUCCESS!')
