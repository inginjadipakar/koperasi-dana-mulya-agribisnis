...
const LogistikModule = {
  ...
  getFullData: function() {
    const stored = localStorage.getItem("DANAMULYA_LOGISTIK_FULL_V6");
    if (stored) {
      try {
  ...
  saveFullData: function(data) {
    localStorage.setItem("DANAMULYA_LOGISTIK_FULL_V6", JSON.stringify(data));
  },
      ...
      <div class="alert alert-primary d-flex align-items-center justify-content-between p-3 mb-4 shadow-sm border-0">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <span class="small text-muted">Seluruh 4 Seksi (I, II, III, IV) disusun berurutan presisi 1:1 sesuai Laporan Resmi Logistik Koperasi!</span>
          </div>
        </div>
              ...
              <div class="row g-3">
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-success bg-opacity-10 h-100">
                    ...
                    <div class="mb-2"><label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label><input type="number" step="0.1" class="form-control form-control-sm" name="tunai_kg" id="sec2_tunai_kg"></div>
                    <div><label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label><input type="number" class="form-control form-control-sm" name="tunai_harga" id="sec2_tunai_harga"></div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-info bg-opacity-10 h-100">
                    <h6 class="fw-bold text-primary mb-2">POTONGAN RUTIN (I&II)</h6>
                    <div class="mb-2"><label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label><input type="number" step="0.1" class="form-control form-control-sm" name="pot_kg" id="sec2_pot_kg"></div>
                    <div><label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label><input type="number" class="form-control form-control-sm" name="pot_harga" id="sec2_pot_harga"></div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-danger bg-opacity-10 h-100">
                    <h6 class="fw-bold text-danger mb-2">PIUTANG (III)</h6>
                    <div class="mb-2"><label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label><input type="number" step="0.1" class="form-control form-control-sm" name="piu_kg" id="sec2_piu_kg"></div>
                    <div><label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label><input type="number" class="form-control form-control-sm" name="piu_harga" id="sec2_piu_harga"></div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-warning bg-opacity-10 h-100">
                    <h6 class="fw-bold text-dark mb-2">PROGRAM BUNTING</h6>
                    <div class="mb-2"><label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label><input type="number" step="0.1" class="form-control form-control-sm" name="bunt_kg" id="sec2_bunt_kg"></div>
                    <div><label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label><input type="number" class="form-control form-control-sm" name="bunt_harga" id="sec2_bunt_harga"></div>
                  </div>
                </div>
              </div>

              <div class="d-flex justify-content-end mt-3 pt-3 border-top">
                <button type="submit" class="btn btn-success fw-bold px-4"><i class="bi bi-save me-2"></i>Simpan Ke Sheet Penjualan (II)</button>
              </div>
            </form>
          </div>
            ...
            <form id="formLogSec3" onsubmit="LogistikModule.handleSaveSec3(event)">
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" step="0.1" class="form-control" name="kg" required placeholder="0.0">
                </div>
                <div class="col-md-4">
                  <label class="form-label small fw-bold">Harga Beli per KG (Rp)</label>
                  <input type="number" class="form-control" name="harga" required placeholder="4000">
                </div>
                <div class="col-md-12 d-flex justify-content-end">
                  <button type="submit" class="btn btn-primary fw-bold px-4"><i class="bi bi-save me-2"></i>Simpan Ke Sheet Pembelian (III)</button>
                </div>
              </div>
            </form>
          </div>
            ...
            <form id="formLogSec4" onsubmit="LogistikModule.handleSaveSec4(event)">
              <div class="row g-3">
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.1" class="form-control" name="stok_awal" required placeholder="0">
                </div>
                <div class="col-md-3">
                  <label class="form-label small fw-bold">Jumlah Susut (KG)</label>
                  <input type="number" step="0.1" class="form-control" name="susut" required placeholder="0">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12 d-flex justify-content-end">
                  <button type="submit" class="btn btn-info text-white fw-bold px-4"><i class="bi bi-save me-2"></i>Simpan & Hitung Keseimbangan Stok (IV)</button>
                </div>
              </div>
            </form>
          </div>
...
print('DIRECTLY OVERWROTE NEW js/logistik.js WITH 4 SECTIONS SUCCESS!')
