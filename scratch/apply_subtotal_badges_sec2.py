 ...
 * II. PENJUALAN MAKANAN TERNAK (SUBLABEL RP REAL-TIME + JUMLAH TOTAL)
 * III. PEMBELIAN MAKANAN TERNAK
 * IV. STOK MAKANAN TERNAK
 * ============================================================
 */
...
const LogistikModule = {
  ...
  getFullData: function() {
    const stored = localStorage.getItem("DANAMULYA_LOGISTIK_FULL_V8");
    if (stored) {
      try {
  ...
  saveFullData: function(data) {
    localStorage.setItem("DANAMULYA_LOGISTIK_FULL_V8", JSON.stringify(data));
  },
      ...
      <div class="alert alert-primary d-flex align-items-center justify-content-between p-3 mb-4 shadow-sm border-0">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <span class="small text-muted">Struktur Form Presisi 1:1 Sheet Excel! Sub-kategori langsung menghitung (KG × HARGA = RP) secara real-time!</span>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="sec2-pane">
          ...
          <div class="card card-custom p-4 mb-4 shadow-sm border-0">
            ...
            <form id="formLogSec2" onsubmit="LogistikModule.handleSaveSec2(event)">
              ...
              <!-- 4 KATEGORI PEMBAYARAN DENGAN SUBLABEL HASIL RP LIVE (KG X HARGA) -->
              <div class="row g-3">
                <!-- TUNAI -->
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-success bg-opacity-10 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <h6 class="fw-bold text-success mb-0"><i class="bi bi-cash me-1"></i>TUNAI</h6>
                      <span class="badge bg-success small" id="sec2_tunai_rp_badge">Rp 0</span>
                    </div>
                    <div class="mb-2">
                      <label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label>
                      <input type="number" step="0.1" class="form-control form-control-sm" name="tunai_kg" id="sec2_tunai_kg" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                    <div>
                      <label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label>
                      <input type="number" class="form-control form-control-sm" name="tunai_harga" id="sec2_tunai_harga" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-info bg-opacity-10 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <h6 class="fw-bold text-primary mb-0"><i class="bi bi-receipt me-1"></i>POTONGAN RUTIN (I&II)</h6>
                      <span class="badge bg-primary small" id="sec2_pot_rp_badge">Rp 0</span>
                    </div>
                    <div class="mb-2">
                      <label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label>
                      <input type="number" step="0.1" class="form-control form-control-sm" name="pot_kg" id="sec2_pot_kg" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                    <div>
                      <label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label>
                      <input type="number" class="form-control form-control-sm" name="pot_harga" id="sec2_pot_harga" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-danger bg-opacity-10 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <h6 class="fw-bold text-danger mb-0"><i class="bi bi-exclamation-circle me-1"></i>PIUTANG (III)</h6>
                      <span class="badge bg-danger small" id="sec2_piu_rp_badge">Rp 0</span>
                    </div>
                    <div class="mb-2">
                      <label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label>
                      <input type="number" step="0.1" class="form-control form-control-sm" name="piu_kg" id="sec2_piu_kg" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                    <div>
                      <label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label>
                      <input type="number" class="form-control form-control-sm" name="piu_harga" id="sec2_piu_harga" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="p-3 border rounded bg-warning bg-opacity-10 h-100">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <h6 class="fw-bold text-dark mb-0"><i class="bi bi-heart-pulse me-1"></i>PROGRAM BUNTING</h6>
                      <span class="badge bg-warning text-dark small" id="sec2_bunt_rp_badge">Rp 0</span>
                    </div>
                    <div class="mb-2">
                      <label class="form-label extra-small text-muted fw-bold mb-1">Volume (KG)</label>
                      <input type="number" step="0.1" class="form-control form-control-sm" name="bunt_kg" id="sec2_bunt_kg" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                    <div>
                      <label class="form-label extra-small text-muted fw-bold mb-1">Harga / KG (Rp)</label>
                      <input type="number" class="form-control form-control-sm" name="bunt_harga" id="sec2_bunt_harga" placeholder="0" oninput="LogistikModule.calcSec2Preview()">
                    </div>
                  </div>
                </div>
              </div>

              <!-- PREVIEW BADGE JUMLAH OTOMATIS REAL-TIME (TOTAL KG & TOTAL RP) -->
              <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top flex-wrap gap-2">
                <div class="d-flex gap-3 align-items-center flex-wrap">
                  <span class="fw-bold text-dark small"><i class="bi bi-calculator text-success me-1"></i>JUMLAH TOTAL FORM:</span>
                  <span class="badge bg-secondary px-3 py-2 fs-6" id="sec2PreviewKg">JUMLAH TOTAL KG: 0 KG</span>
                  <span class="badge bg-success px-3 py-2 fs-6" id="sec2PreviewRp">JUMLAH TOTAL RP: Rp 0</span>
                </div>
  ...
  calcSec2Preview: function() {
    ...
    // Update Subtotal Rp Badge tiap kotak
    const elTRp = document.getElementById("sec2_tunai_rp_badge");
    const elPRp = document.getElementById("sec2_pot_rp_badge");
    const elIuRp = document.getElementById("sec2_piu_rp_badge");
    const elBRp = document.getElementById("sec2_bunt_rp_badge");

    if (elTRp) elTRp.innerText = "Rp " + tRp.toLocaleString("id-ID");
    if (elPRp) elPRp.innerText = "Rp " + pRp.toLocaleString("id-ID");
    if (elIuRp) elIuRp.innerText = "Rp " + iuRp.toLocaleString("id-ID");
    if (elBRp) elBRp.innerText = "Rp " + bRp.toLocaleString("id-ID");
...
print('DIRECTLY APPLIED SUBTOTAL BADGES TO SEC 2 SUCCESS!')
